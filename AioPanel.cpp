  ...
  wxPanel(parent, id, pos, size, wxTAB_TRAVERSAL)
{
  ...
  clockSourceLabel_2 = new wxStaticText(this, wxID_ANY, wxT("Internal"));
  sizer_13->Add(clockSourceLabel_2, 0, wxEXPAND|wxLEFT|wxRIGHT, 4);
  ...
  sampleRateLabel_2 = new wxStaticText(this, wxID_ANY, wxT("47999 Hz"));
  sampleRateLabel_2->SetBackgroundColour(wxColour(255, 198, 0));
  sizer_14->Add(sampleRateLabel_2, 0, wxEXPAND|wxLEFT|wxRIGHT, 4);
  ...
  bufferSizeLabel_2 = new wxStaticText(this, wxID_ANY, wxT("1024"));
  sizer_15->Add(bufferSizeLabel_2, 0, wxEXPAND|wxLEFT|wxRIGHT, 4);
  ...
  masterButton = new wxRadioButton(this, wxID_ANY, wxT("Internal"));
  ...
  internalFreqChoice->SetSelection(1);
  ...
  wclkSyncButton = new wxRadioButton(this, wxID_ANY, wxT("Word Clk"));
  ...
  sizer_5->Add(outputLevelBox, 0, wxEXPAND|wxFIXED_MINSIZE, 0);
  ...
  phonesLevelBox = new wxRadioBox(this, phonesLevelID, wxT("Phones Level"), wxDefaultPosition, wxDefaultSize, 3, phonesLevelBox_choices, 1, wxRA_SPECIFY_COLS);
  phonesLevelBox->SetSelection(2);
  ...
  wxFlexGridSizer* sizer_17 = new wxFlexGridSizer(1, 2, 0, 0);
  sizer_2->Add(sizer_17, 1, wxEXPAND, 0);
  wxStaticBoxSizer* sizer_21 = new wxStaticBoxSizer(new wxStaticBox(this, wxID_ANY, wxT("Expansion Boards")), wxHORIZONTAL);
  sizer_17->Add(sizer_21, 1, wxALL|wxEXPAND, 4);
  wxBoxSizer* sizer_19 = new wxBoxSizer(wxHORIZONTAL);
  sizer_21->Add(sizer_19, 1, wxEXPAND, 0);
  aebiPresentCheckBox = new wxCheckBox(this, wxID_ANY, wxT("AI4S-192 AIO"));
  aebiPresentCheckBox->Enable(0);
  sizer_19->Add(aebiPresentCheckBox, 0, 0, 0);
  aeboPresentCheckBox = new wxCheckBox(this, wxID_ANY, wxT("AO4S-192 AIO"));
  aeboPresentCheckBox->Enable(0);
  sizer_19->Add(aeboPresentCheckBox, 0, 0, 0);
  tcoPresentCheckBox = new wxCheckBox(this, wxID_ANY, wxT("TCO"));
  tcoPresentCheckBox->Enable(0);
  tcoPresentCheckBox->SetValue(1);
  sizer_19->Add(tcoPresentCheckBox, 0, 0, 0);
  wxStaticBoxSizer* sizer_20 = new wxStaticBoxSizer(new wxStaticBox(this, wxID_ANY, wxT("FW version")), wxHORIZONTAL);
  sizer_17->Add(sizer_20, 0, wxALL|wxEXPAND, 4);
...
BEGIN_EVENT_TABLE(AioPanel, wxPanel)
  ...
  EVT_RADIOBUTTON(wxID_ANY, AioPanel::setMasterMode)
  ...
  EVT_COMMAND_SCROLL_CHANGED(pitchID, AioPanel::pitchChangedCB)
...
void AioPanel::setMasterMode(wxCommandEvent &event)  // wxGlade: AioPanel.<event_handler>
{
  event.Skip();
  // notify the user that he hasn't implemented the event handler yet
  wxLogDebug(wxT("Event handler (AioPanel::setMasterMode) not implemented yet"));
}
...
void AioPanel::pitchChangedCB(wxScrollEvent &event)  // wxGlade: AioPanel.<event_handler>
{
  event.Skip();
  // notify the user that he hasn't implemented the event handler yet
  wxLogDebug(wxT("Event handler (AioPanel::pitchChangedCB) not implemented yet"));
}
